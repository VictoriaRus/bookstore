...
const Like = ({ book }: IBookProps) => {
    ...
    return (
        <BackgroundLike onClick={ setFavoritesBooks }>
            {
                active ?
                    <svg width="20" height="18" viewBox="0 0 20 18" fill="#FC857F" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            stroke="#FC857F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                    :
